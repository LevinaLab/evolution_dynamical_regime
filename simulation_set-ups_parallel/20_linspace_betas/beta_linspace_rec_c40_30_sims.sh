...
subfolder_add="beta_linspace_rec_c40_30_sims"
subfolder="sim-$(date '+%Y%m%d-%H%M%S')_parallel_$subfolder_add"
# date="date +%s"
# subfolder="$date$subfolder"

command="python3 train.py -b_linspace {1} -1 1 30 -g 4001 -t 2000 -compress -noplt -rec_c 40 -c 6 -subfolder ${subfolder} -n Run_{1}"
