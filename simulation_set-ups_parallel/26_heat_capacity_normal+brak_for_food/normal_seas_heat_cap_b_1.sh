...
command="python3 train.py -g 2 -t 2000 -no_commands -compress -li 3999 -l sim-20201022-190553_parallel_b1_normal_seas_g4000_t2000/sim-20201022-190555-b_1_-g_4000_-t_2000_-noplt_-subfolder_sim-20201022-190553_parallel_b1_normal_seas_g4000_t2000_-n_Run_{1} -rec_c 1 -c_props 500 10 -2 2 300 40 -c 2 -noplt -subfolder ${subfolder} -n Run_{1}"
