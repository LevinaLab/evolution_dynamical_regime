...
subfolder_add="b1_dynamic_range_c_20_g8000_t2000_10_sims"
subfolder="sim-$(date '+%Y%m%d-%H%M%S')_parallel_$subfolder_add"
# date="date +%s"
# subfolder="$date$subfolder"

command="python3 train.py -b 1 -g 8001 -t 2000 -compress -noplt -rec_c 100 -c 8 -subfolder ${subfolder} -n Run_{1}"
