...
subfolder_add="b3.16_delta_-0-5_dynamic_range_c_20_g4000_t2000_10_sims"
subfolder="sim-$(date '+%Y%m%d-%H%M%S')_parallel_$subfolder_add"
# date="date +%s"
# subfolder="$date$subfolder"

command="python3 train.py -b 3.16 -g 4001 -t 2000 -compress -noplt -rec_c 100 -c 3 -subfolder ${subfolder} -n Run_{1}"
