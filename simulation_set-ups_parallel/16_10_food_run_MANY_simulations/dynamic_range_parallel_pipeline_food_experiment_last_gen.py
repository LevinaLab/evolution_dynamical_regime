...
if __name__=='__main__':
    ...
    pipeline_settings = {}
    pipeline_settings['varying_parameter'] = 'food' #'time_steps'  # 'food'
    pipeline_settings['cores'] = 80
    pipeline_settings['num_repeats'] = 1
    if pipeline_settings['varying_parameter'] == 'food':
        pipeline_settings['lowest_food_percent'] = 1
        pipeline_settings['highest_food_percent'] = 10000
    elif pipeline_settings['varying_parameter'] == 'time_steps':
        pipeline_settings['lowest_food_percent'] = 1
        pipeline_settings['highest_food_percent'] = 2500
    pipeline_settings['resolution'] = 10
    pipeline_settings['add_save_file_name'] = 'trained_on_10_foods_res_10_last_gen_max_food_1000'
    ...
    folder_names = ['sim-20201126-221841_parallel_b1_10_foods_g4000_t2000_g2000_27_sims', 'sim-20201126-221850_parallel_b10_10_foods_g4000_t2000_g2000_54_sims']#, 'sim-20201119-190204_parallel_b10_normal_run_g4000_t2000_54_sims']
