...
command="python3 train.py -b_linspace {1} -1 1.5 3 -g 20 -t 2 -v_eat_max 0.005 -compress -c_props 2 2 -2 2 100 40 -noplt -rec_c 10 -c 3 -subfolder ${subfolder} -n Run_{1}"
