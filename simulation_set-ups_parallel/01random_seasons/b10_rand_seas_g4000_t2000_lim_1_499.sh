...
subfolder_add="b10_rand_seas_g4000_t2000_lim_1_499"
subfolder="sim-$(date '+%Y%m%d-%H%M%S')_parallel_$subfolder_add"
# date="date +%s"
# subfolder="$date$subfolder"

command="python3 train.py -b 10 -g 4000 -t 2000 -rand_seas -rand_seas_lim 1 499 -subfolder ${subfolder} -n Run_{1}"
