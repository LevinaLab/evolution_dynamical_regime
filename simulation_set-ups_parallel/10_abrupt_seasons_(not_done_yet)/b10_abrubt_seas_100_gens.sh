...
subfolder_add="b10_abrubt_seas_100_gens"
subfolder="sim-$(date '+%Y%m%d-%H%M%S')_parallel_$subfolder_add"
# date="date +%s"
# subfolder="$date$subfolder"

command="python3 train.py -b 10 -g 2000 -t 2000 -aseas_len 100 -energies 0 100 500 1000 1999 -subfolder ${subfolder} -n Run_{1}"
